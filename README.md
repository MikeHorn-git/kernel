...
![image](https://github.com/MikeHorn-git/kernel/assets/123373126/e4fca8a7-782a-42a7-863e-431a94660313)

## Table of contents

- [Blacklist Modules](https://github.com/MikeHorn-git/kernel#blacklist-modules-100)
- [GRUB Parameters](https://github.com/MikeHorn-git/kernel#grub-parameters-25)
- [Kernel Parameters](https://github.com/MikeHorn-git/kernel#kernel-parameters-50)
- [Installation Script](https://github.com/MikeHorn-git/kernel#installation-script)
- [Kconfigs](https://github.com/MikeHorn-git/kernel#kconfigs)
- [Compile Kernel](https://github.com/MikeHorn-git/kernel#compile-kernel)
- [Kernel Installation](https://github.com/MikeHorn-git/kernel#kernel-installation)
- [Security Audit](https://github.com/MikeHorn-git/kernel#security-audit)
- [Resources](https://github.com/MikeHorn-git/kernel#resources)

## Blacklist Modules (+100)

> [!Note]
> Present in **conf/blacklist.conf**
...
# Take custom .config
cd /usr/src/linux
wget https://raw.githubusercontent.com/MikeHorn-git/kernel/main/kconfigs/gentoo/config
mv config .config
```
...
```bash
# Last stable
export KVERSION=6.16.5
wget https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-"$KVERSION".tar.xz
tar -xf linux-"$KVERSION".tar.xz
cd linux-"$KVERSION"
wget https://raw.githubusercontent.com/MikeHorn-git/kernel/main/kconfigs/vanilla/config
mv config .config
```
